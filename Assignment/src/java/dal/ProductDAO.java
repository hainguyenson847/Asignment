...
public class ProductDAO extends DBContext {
    ...
    public int countProduct() {
        String sql = "select count(*) as co from Products";
        int c = 0;
        try {
            PreparedStatement ps = connection.prepareStatement(sql);
    ...
    public List<Product> getProductsByPriceAsc() {
        String sql = "select * from Products order by SalePrice";
        List<Product> list = new ArrayList<>();
        /*
        Pid int IDENTITY(1,1) NOT NULL primary key,
	ProductName nvarchar(300) not null,
    ...
    public List<Product> getProductsByPriceDesc() {
        String sql = "select * from Products order by SalePrice desc";
        List<Product> list = new ArrayList<>();
        /*
        Pid int IDENTITY(1,1) NOT NULL primary key,
	ProductName nvarchar(300) not null,
    ...
    public List<Product> getProductsByPrice10_50() {
        String sql = "select * from Products where SalePrice between 10000 and 50000";
        List<Product> list = new ArrayList<>();
        /*
        Pid int IDENTITY(1,1) NOT NULL primary key,
	ProductName nvarchar(300) not null,
    ...
    public List<Product> getProductsByPrice50_100() {
        String sql = "select * from Products where SalePrice between 50000 and 100000";
        List<Product> list = new ArrayList<>();
        /*
        Pid int IDENTITY(1,1) NOT NULL primary key,
	ProductName nvarchar(300) not null,
    ...
    public List<Product> getProductsByPrice100_500() {
        String sql = "select * from Products where SalePrice between 100000 and 500000";
        List<Product> list = new ArrayList<>();
        /*
        Pid int IDENTITY(1,1) NOT NULL primary key,
	ProductName nvarchar(300) not null,
    ...
    public List<Product> getRelevantProducts(int cid, int pid) {
        String sql = "select * from Products where cid = ? and pid != ?";
        List<Product> list = new ArrayList<>();
        /*
        Pid int IDENTITY(1,1) NOT NULL primary key,
	ProductName nvarchar(300) not null,
