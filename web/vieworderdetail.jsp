    ...
    <body>
        <div class="row " style="margin-bottom: 500px">
            ...
            <c:forEach items="${sessionScope.listodd}" var="li">
                ...
                <div class="col-lg-3 text-center border center-content">
                    <c:if test="${li.p.discount > 0}">
                        <span id="tp${li.p.pid}" style="color: red; font-weight: bold">${Integer(li.p.salePrice * (1 - li.p.discount) / 1000) * li.quantity}.000đ</span>
                    </c:if>
                    <c:if test="${li.p.discount == 0}">
                        <span id="tp${li.p.pid}" style="color: red; font-weight: bold">${Integer(li.p.salePrice / 1000) * li.quantity}.000đ</span>
                    </c:if>
                </div>  
