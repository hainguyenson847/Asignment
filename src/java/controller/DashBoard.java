...
public class DashBoard extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (role != null) {
            ...
            if (mag.equalsIgnoreCase("account")) {
                String username = request.getParameter("username");
                ad.deleteAccount(username);
                response.sendRedirect("admin?manage=account");
            }
            else if(mag.equalsIgnoreCase("order")) {
                if(role.equalsIgnoreCase("delete")) {
                    int oid = Integer.parseInt(request.getParameter("oid"));
                    od.deleteOrder(oid);
                    response.sendRedirect("admin?manage=order");
                }
            ...
            else if(mag.equalsIgnoreCase("product")) {
                if(role.equalsIgnoreCase("delete")) {
                    ...
                    int pid = Integer.parseInt(request.getParameter("pid"));
                    response.sendRedirect("editprod?pid=" + pid);
                }
            }
        }
